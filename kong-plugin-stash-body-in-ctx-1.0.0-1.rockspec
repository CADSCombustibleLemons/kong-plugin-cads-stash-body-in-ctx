package = "kong-plugin-stash-body-in-ctx"
...
local pluginName = package:match("^kong%-plugin%-(.+)$")  -- "stash-body-in-ctx"
supported_platforms = {"linux", "macosx"}

source = {
  url = "git://github.com/CADSCombustibleLemons/kong-plugin-stash-body-in-ctx",
  tag = "1.1.0",
}
description = {
  ...
  homepage = "https://github.com/CADSCombustibleLemons/kong-plugin-stash-body-in-ctx.git",
  license = "Apache 2.0"
}
dependencies = {
  "lua ~> 5"
